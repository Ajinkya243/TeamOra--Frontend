...
const Aside=()=>{
    ...
    return(
        <div className={classes.aside}>
         <Link className={`${classes.link} ${tab==='dashboard'?classes.active:''}`}><FontAwesomeIcon className={classes.icon} icon={faHouseChimney} size="xl"  /><span>Home</span></Link>
         <Link className={classes.link}><FontAwesomeIcon className={classes.icon} icon={faList} size="xl"  /><span>Projects</span></Link>
         <Link className={classes.link}><FontAwesomeIcon className={classes.icon} icon={faPeopleGroup} size="xl"  /><span>Team</span></Link>
